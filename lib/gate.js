...
function printUpgradeMessage(feature) {
  ...
  console.log(`${DIM}  This feature requires SEO Intel Solo (€9.99/mo).${RESET}`);
  console.log('');
  ...
  return `
    <div class="card" style="text-align:center; padding: 32px 24px; opacity: 0.7;">
      ...
      <p style="font-size: 0.72rem; color: var(--text-muted); margin-bottom: 12px;">
        This section requires SEO Intel Solo (€9.99/mo)
      </p>
...
export function printLicenseStatus() {
  ...
  if (license.tier === 'agency') {
    ...
    console.log(`${DIM}  Upgrade: ${CYAN}https://ukkometa.fi/en/seo-intel/${RESET} ${DIM}— Solo €9.99/mo · €79/yr${RESET}`);
  }
  console.log('');
}
