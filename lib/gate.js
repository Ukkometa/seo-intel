...
const FEATURE_NAMES = {
  ...
  'entity-audit':      'Entity Mapping & Schema Audit',
  'triangulation':     'Content Triangulation Scanner',
  'gsc-platform':      'GSC Platform Property & Query Gaps',
  'geo':               'GEO & LLM Retrieval Evaluator',
  'schema-audit':      'Schema Specificity Audit',
  'loop':              'Content Loop Orchestrator',
  'prescore':          'Pre-Publish AEO Scorer',
};
...
//   • Production  — blog-draft, loop (2026-08-22)
//
// The production line is a deliberate revision of the original bet, not a
// tightening by accident. Reading your own site stays free: the AI Citability
// Audit, rescore, tech-audit and every own-site digest are the acquisition
// hook and must stay reachable without a licence. But blog-draft and loop are
// "do the work for me" rather than "show me my data" — repeat-use, high value
// per call, and only reached after the free audit has already demonstrated the
// product. That is the right place to charge, not the first touch.
//
...
const FREE_FEATURES = new Set([
  ...
  'entity-audit',   // Organization/sameAs identity map (own site)
  'triangulation',  // YouTube + GitHub + technical-schema proof matrix (own site)
  'gsc-platform',   // your own verified Search Console properties (own site)
  'geo',            // LLM retrieval-shape audit (own site)
  'schema-audit',   // schema type/required-field specificity (own site)
  'page-contract',  // query-led decision for one of your own pages
  'gsc-import',     // import your own Search Console exports
  'prune-duplicate-urls', // housekeeping on your own crawl data
  'backlink-import',// your own Search Console link export
  'backlink-audit', // reclamation + equity on your own link profile
]);
